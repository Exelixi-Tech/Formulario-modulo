...
// NEXUS_EXPECTED_SUBMODULO_IDS=18,22 (lista) o el legacy NEXUS_EXPECTED_SUBMODULO_ID.
...
async function nexusAuth(req, res, next) {
  ...
  // confiables — el caller ya autenticó al usuario. Se omite el check de submodule
  ...
  // Activación tarjeta farmacia — cadena OCR→Formulario sin nexus_token
  ...
  try {
    ...
    // Proxy interno: saltar verificación de submódulo
